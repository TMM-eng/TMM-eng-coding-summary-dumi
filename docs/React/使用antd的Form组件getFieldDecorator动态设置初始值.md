# 使用 antd 的 Form 组件 getFieldDecorator 动态设置初始值
...
rules 数组里面的元素可以是方法，具体参数见下面源码。验证多重选择框中确保每一个元素都是一个数字：
...
参考 antd 官网文档：[https://ant.design/components/form-cn/#header](https://ant.design/components/form-cn/#header)
